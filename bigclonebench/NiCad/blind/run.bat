...
java %OPTIONS% -cp %TOOL_JAR% drdup.Diff drdup-bigclonebench-separated.xml bigclonebench-blind-minsize-6-dir.xml drdup2-nicad.xml
java %OPTIONS% -cp %TOOL_JAR% drdup.Diff bigclonebench-blind-minsize-6-dir.xml drdup-bigclonebench-separated.xml nicad-drdup2.xml
