...
## Latest Version
Latest version is available for download: <a href="https://github.com/tronicek/DrDup2/blob/master/DrDup2-1.0-jar-with-dependencies.jar">DrDup2-1.0-jar-with-dependencies.jar</a>.
