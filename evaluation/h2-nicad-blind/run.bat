...
java -cp %TOOL_JAR% drdup.Diff %NICAD10d% drdup-h2-5-separated.xml nicad-blind-10-drdup-5.xml
java -cp %TOOL_JAR% drdup.Diff drdup-h2-10-separated.xml %NICAD5d% drdup-10-nicad-blind-5.xml
