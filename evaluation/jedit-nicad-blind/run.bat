...
set NICAD3="jedit-blind-minsize-3.xml"
set NICAD3d="jedit-blind-minsize-3-dir.xml"
set NICAD8="jedit-blind-minsize-8.xml"
set NICAD8d="jedit-blind-minsize-8-dir.xml"
...
java -cp %TOOL_JAR% drdup.Diff %NICAD8d% drdup-jedit-3-separated.xml nicad-blind-8-drdup-3.xml
java -cp %TOOL_JAR% drdup.Diff drdup-jedit-8-separated.xml %NICAD3d% drdup-8-nicad-blind-3.xml
