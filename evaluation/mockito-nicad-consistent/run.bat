...
java -cp %TOOL_JAR% drdup.Diff %NICAD8d% drdup-mockito-3-separated.xml nicad-consistent-8-drdup-3.xml
java -cp %TOOL_JAR% drdup.Diff drdup-mockito-8-separated.xml %NICAD3d% drdup-8-nicad-consistent-3.xml
