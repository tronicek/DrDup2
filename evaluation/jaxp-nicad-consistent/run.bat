...
set NICAD5="jaxp-consistent-minsize-5.xml"
set NICAD5d="jaxp-consistent-minsize-5-dir.xml"
set NICAD10="jaxp-consistent-minsize-10.xml"
set NICAD10d="jaxp-consistent-minsize-10-dir.xml"
...
java -cp %TOOL_JAR% drdup.Diff %NICAD10d% drdup-jaxp-5-separated.xml nicad-consistent-10-drdup-5.xml
java -cp %TOOL_JAR% drdup.Diff drdup-jaxp-10-separated.xml %NICAD5d% drdup-10-nicad-consistent-5.xml
