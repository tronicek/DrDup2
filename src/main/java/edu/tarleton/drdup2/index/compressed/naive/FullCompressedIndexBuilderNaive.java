...
/**
 * The class that builds the full compressed method-level index.
 *
 * @author Zdenek Tronicek, tronicek@tarleton.edu
 */
public class FullCompressedIndexBuilderNaive extends CompressedIndexBuilder {
    ...
    public FullCompressedIndexBuilderNaive(Properties conf, Path srcDir) {
        super(conf, srcDir);
