 ...
 */
public class SimplifiedCompressedIndexStmtBuilder extends CompressedIndexBuilder {
    ...
    public SimplifiedCompressedIndexStmtBuilder(Properties conf, Path srcDir) {
        super(conf, srcDir);
    }
