...
/**
 * The builder that builds the full compressed method-level index. It uses the
 * blind renaming strategy.
 *
 * @author Zdenek Tronicek, tronicek@tarleton.edu
 */
public class FullCompressedIndexBuilder extends CompressedIndexBuilder {
    ...
    public FullCompressedIndexBuilder(Properties conf, Path srcDir) {
        super(conf, srcDir);
    ...
    private void addChildEndMethod(Node n) {
        String type = n.getClass().getSimpleName();
        extendTrie(type + "_end", methodLevel);
        stack.pop();
    }
