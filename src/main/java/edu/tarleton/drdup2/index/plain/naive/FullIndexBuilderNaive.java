...
/**
 * The class that builds the full plain (not compressed) method-level index.
 *
 * @author Zdenek Tronicek, tronicek@tarleton.edu
 */
public class FullIndexBuilderNaive extends IndexBuilder {
    ...
    public FullIndexBuilderNaive(Properties conf, Path srcDir) {
        super(conf, srcDir);
